"""
Python re-implementation of "High-Speed Tracking with Kernelized Correlation Filters"
@book{title={High-Speed Tracking with Kernelized Correlation Filters},
